...
import kotlinx.android.synthetic.main.interforces_quiz_summary.*


class InterforcesQuizSummaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.interforces_quiz_summary)


        interforcesleaderboard_button.setOnClickListener(){
        ...
        interforcesreplay.setOnClickListener(){

            val intent = Intent(this@InterforcesQuizSummaryActivity, InterforcesQuizActivity::class.java)
